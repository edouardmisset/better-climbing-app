          ...
          ({
            ...
            return (
              <tr key={id} className={`${styles.row} grid-full-width`}>
                <td title={discipline} className={`${styles.cell} margin-auto`}>
                ...
                <td className={styles.cell}>
                  <em
                    title={`Topo Grade: ${formattedGrade}${topoGrade === personalGrade || personalGrade == null ? '' : ` - Personal Grade: ${displayGrade({ grade: personalGrade, discipline })}`}`}
                    className="monospace"
                  >
                    <span>
